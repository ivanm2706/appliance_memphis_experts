export const info = [
  ...
  },
  {
    ...
    commonRepairs: {
      ...
      footerText: [
        ...
        'Furthermore, Atlanta Appliance Services can install the new one, so it is done right the first time. Atlanta Appliance Services exceeds expectations and ensures complete satisfaction for your appliance services in Loganville, GA and the surrounding areas.',
      ],
      issues: [
        {
  ...
  },
  {
    ...
    nameImg: 'about-us-page-street.jpg',
    contentFirst:
      'There is no doubt, modern appliances make life convenient, and we rely on them every day. If one of them breaks down or starts to malfunction, it can disrupt our daily life and cause problems. At Atlanta Appliance Services, we provide professional repair services for all kinds of appliances.',
    contentSecond:
      'Our trained and experienced technicians will make sure your damaged device is up and running in no time. So, if you’re looking for reliable appliance repair in Loganville, GA and the surrounding areas, we’re the right choice for you.',
    commonRepairs: {
      description: '',
      footerText: '',
      issues: [],
