    ...
    <>
      ...
      <section>
        <div className="container container--page container--pi-10 container--pb-mainSection">
          <PicturesBlock
            imageNames={['LG-dryer-kept-spinning-when-everything-was-off-control-board-replaced-1-600x600.jpg', 'LG-dryer-kept-spinning-when-everything-was-off-control-board-replaced-2-600x600.jpg', 'LG-dryer-kept-spinning-when-everything-was-off-control-board-replaced-3-600x600.jpg']}
        ...
        <div className="container container--page container--pi-10">
          <Frame mode='white'>
            ...
            <div className="container container--conter">
              <p className="page__subtitle">To determine whether you need a dryer repair expert, here are a few of the more obvious signs you may notice.</p>
            </div>

            <ImageTextModule
              p={['A buckle or zipper is a familiar noise. But a really loud noise is not correct. This could indicate that your dryer belt is loose. Call for repair before resuming use.', 'As soon as there is that familiar smell that something is burning, please shut the dryer off and unplug it immediately. Dryer fires can cause the casing to melt, do internal damage, and even cause a fire in your home. Additionally, be sure to always clean out the filters and have dryer vents cleaned out every year.']}
              strongStartTextForEveryP={['A loud noise is coming from the dryer. ', 'There is a burning smell. ']}
              orderNumberForList={[1, 2]}
              pStyleSecond
            >
              <span className="imageTextModule__frame" style={{...imageStyle, backgroundImage: 'url("./images/dryer-repair-maintenance-1.jpg")', backgroundSize: 'contain',}} />
            </ImageTextModule>

            <ImageTextModule
              p={['When the drum is not spinning, your belt may have damage. In that case, your clothes will not dry. So, call for dryer repair as soon as you notice the problem.', 'Suppose it takes a couple or more cycles to dry regular clothes. In that case, you could have a broken belt, sensor, or an electrical problem. And running the dryer multiple times costs more energy and money. Call for an immediate repair.']}
              strongStartTextForEveryP={['The dryer motor is on, but it is not moving. ', 'The clothes are taking way too long to dry. ']}
              orderNumberForList={[3, 4]}
              pStyleSecond
              isPictureLeft
            >
              <span className="imageTextModule__frame" style={{...imageStyle, backgroundImage: 'url("./images/dryer-repair-maintenance-2-1.jpg")', backgroundSize: 'contain',}} />
            </ImageTextModule>

            <div className="container container--mb-15">
              <ol start={5} className="list--ordered">
                <li>
                  <strong>The air in the dryer seems more humid than it should.</strong>
                  &nbsp;
                ...
                <li>
                  <strong>The dryer is moving all around the laundry room.</strong>
                  &nbsp;
      ...
      <section>
        <div className="container container--page container--pi-10 container--pb-mainSection">
          <h3 className="page__titleH3">Quality Repair Parts for Dryer Repair</h3>

          <div className="container container--mb-15">
            <PicturesBlock
              imageNames={['heating-element-whirlpool-dryer-1-600x600.jpg', 'heating-element-whirlpool-dryer-2-600x600.jpg', 'heating-element-whirlpool-dryer-4-600x600.jpg']}
          ...
          <p className="page__subtitle">
            Often a broken dryer requires a replacement component. The repair will only be durable if we use good-quality spares. The professionals at&nbsp;
            <strong>Atlanta Appliance Services</strong>
            &nbsp;know how to find the best spare parts. And that is good news for you. Furthermore, our team knows which products have performed well in real-life conditions and will use those components in your repairs. That is another instance where our experience is to your benefit.
          </p>

          <p className="page__subtitle">Our team can find good-quality spares for all kinds of appliances and brands. We have spare parts for dishwashers, freezers, refrigerators, garbage disposals, ovens, ranges, and other such instruments. No matter what kind of repair you need, our team can help.</p>
          ...
          <Frame mode='dark'>
            <div className="container container--maxW-800 container--center">
              <div className="callUs callUs--white">
                <p>
                  To learn more about the dryer repair and installation we provide in Loganville, GA and the surrounding areas, don’t hesitate to call our staff at&nbsp;
                  <strong>Atlanta Appliance Services</strong>
                  &nbsp;at
                </p>
